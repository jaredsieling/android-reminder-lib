...
public class LocationTrigger extends TriggerBase {
	...
	@Override
	public void launchTriggerCreateActivity(Context context, final String campaignUrn, final String campaignName, String [] actions, String[] preselectedActions, boolean adminMode) {
		...
		LocTrigEditActivity.setOnExitListener(
			...
			public void onDone(Context context, int trigId, 
				...
				addNewTrigger(context, campaignUrn, campaignName, trigDesc, actDesc);
			}
		});

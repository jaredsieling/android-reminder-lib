...
package org.ohmage.reminders.ui;
...
import org.ohmage.reminders.notif.NotifEditActivity;
import org.ohmage.reminders.notif.NotifSettingsActivity;
...
public class TriggerListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdminMode = getResources().getBoolean(R.bool.admin_mode);
    ...
    private Dialog createDeleteConfirmDialog(int trigId) {
        ...
        return new AlertDialog.Builder(this).setNegativeButton(android.R.string.cancel, null)
